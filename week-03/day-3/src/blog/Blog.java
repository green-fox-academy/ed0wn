...
public class Blog {
  List<BlogPost> blog= initializeBlogPost();

  public static List<BlogPost> initializeBlogPost (){
    List<BlogPost> blog= new ArrayList<>();
    blog.add(new BlogPost("John Doe", "Lorem Ipsum","Lorem ipsum dolor sit amet.", "2000.05.04."));
    blog.add(new BlogPost("Tim Urban", "Wait but why", "A popular long-form, stick-figure-illustrated blog about almost everything.", "201.10.10"));
